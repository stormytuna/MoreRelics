package morerelics.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import morerelics.MoreRelics;
import morerelics.util.CardStats;
import morerelics.util.TriFunction;
...
import static morerelics.util.GeneralUtils.removePrefix;
import static morerelics.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return MoreRelics.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    MoreRelics.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
